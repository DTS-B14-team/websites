...
<html>
  ...
  <header>
    <div class="container">
      <div class="header-left" id="home">B14</div>
        ...
        <div class="content">
          <div class="contents-item item1">
            <img src="img/ari.jpg" alt="" class="img-responsive">
                ...
                <div class="social">
                  <a href="https://facebook.com/aryp21"><i class="fa fa-facebook"></i></a>
                  <a href="https://twitter.com/kucingjungkook"><i class="fa fa-twitter"></i></a>
                  <a href="https://instagram.com/aripurnomoaji"><i class="fa fa-instagram"></i></a>
                </div>
          </div>
        </div>
        <div class="content">
